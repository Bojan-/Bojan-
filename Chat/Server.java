...
public class Server implements HttpHandler {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Get list of messagess: GET http://" + serverHost + ":" + port + "/chat?token={token}");
    ...
    private void doPost(HttpExchange httpExchange) throws Exception {
        ...
        System.out.println("New task from User : " + message.toString() );
	...
	{
	    if (messageList.get(j).id.equals(message.id)) {
        	messageList.get(j).messageText = message.messageText;
		break;
	    }
	}
    }
